...
import classes from "./BodyMultipleCommand.module.css";

const videoSubject = "./video/subject1/";

function BodyMultipleCommand(props) {
  ...
  return (
    <>
      ...
      <div className={classes.divContainer}>
        ...
        <VideoButtons
          onStart={() => {
            if (!stateBody.disabled) dispatch({ type: "START" });
          }}
          onReset={() => {
...
export default BodyMultipleCommand;
